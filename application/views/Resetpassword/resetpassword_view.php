                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-3">
                                                        <input name="std_username" type="text"  class="form-control" placeholder="Enter New Password*">
                                                    </div>
                                                    <div class="form-group mb-3">
                                                        <input name="std_username" type="text"  class="form-control" placeholder="Re-Enter New Password*">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <button type="submit" class="site-button">Change Password</button>
                                                    </div>
                                                </div>
